...
def compute():
    global important_features, unimportant_features, del_u, del_v
    first_time = True

    for global_list in g_list:
        if first_time:
            ...
            for feat in important_features.keys():
                if feat in updated_global_feature_list:
                    important_features[feat] = updated_global_feature_list.pop(feat)
            unimportant_features = updated_global_feature_list
